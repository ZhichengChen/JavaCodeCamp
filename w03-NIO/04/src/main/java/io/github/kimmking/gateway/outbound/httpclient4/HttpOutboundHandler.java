...
import io.github.kimmking.gateway.router.RoundRibbonHttpEndpointRouter;
...
public class HttpOutboundHandler {
  ...
  //RoundRibbon
//  static HttpEndpointRouter router = new RoundRibbonHttpEndpointRouter();
  //Weight
